...
This mod contains two simple-to-install versions; one for those who prefer vanilla animations and those who prefer their weapons to be... not _smooth_, per se... we'll call it "slightly crispy".  We'll cover what's the same between the two first:

**The Ultimate Doom QOL**

This is one I've already released before, but it's got a small update to it.  It contains:
- New level graphics with the author's name for episodes 1-4 (5 and 6 kinda speak for themselves, yeah?)
- New WIENTER and WIF graphics
- Animated maps for Thy Flesh Consumed, Sigil, and Sigil II.  Originally created by Elf-Alchemist and DevilMyEyes, which I then ported to Doom Retro compatibility.
- Improved water flats shamelessly borrowed from DASI-I from their DOOMone project.
...
- New WIENTER and WIF graphics
- Animated maps for the three separate "episodes" of Hell on Earth plus the secret levels.  Originally created by Elf-Alchemist and DevilMyEyes, which I then ported to Doom Retro compatibility.
- Improved water flats shamelessly borrowed from DASI-I from their DOOMone project.
- Discrete interlevel backgrounds for nerve and The Master Levels.
- Replacement of D_ or H_DM2INT, aka "Doom II Intermission", with S_ or H_E2M9, aka "Untitled".  Feels a lot more like the "you did it, Get Psyched for the next one" energy Doom 1 has.

**Legacy of Rust QOL**

- New level graphics with the author's name for Hell On Earth and both expansions
- New WIENTER and WIF graphics
- New sprite for the Shocktrooper (he's actually holding a Plasma Rifle now :D )
- Improved firing animation for the Mindweaver
- Fullbright on a few explosive frames in the Mindweavers' and Tyrants' death animations.
- One (1) new decor sprite, CBR2, to match the other candles that got replaced.
- Replacement of D_BILGE, aka "Bilge Punks".  It's not grating the way E2M4 is; it just feels too different to me, tonally, personally, from the rest of the soundtrack (which is excellent).  I have replaced it with "Yaw" by Jimmy Paddock, from the BTSX OST.  I'm sorry Xaser; all the other tracks are bangers tho <3
- New animation sprites for the Incinerator and the Calamity Blade.
